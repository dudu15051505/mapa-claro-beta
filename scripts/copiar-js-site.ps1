...
Copy-Item "$diretorio_trabalho/js/locations-data-update.js" -Destination "$diretorio_trabalho/bk/$DateStr/locations-data-update.js" -Recurse -force
...
Copy-Item "$diretorio_trabalho/js/locations-data-lista.txt" -Destination "$diretorio_trabalho/bk/$DateStr/locations-data-lista.txt" -Recurse -force

Copy-Item "$diretorio_trabalho/js/locations-data-update.js" -Destination "$diretorio_site/js/locations-data-update.js" -Recurse -force
...
Copy-Item "$diretorio_trabalho/js/locations-data-lista.txt" -Destination "$diretorio_site/js/locations-data-lista.txt" -Recurse -force

Copy-Item "$diretorio_trabalho/js/locations-data-update.js" -Destination "$diretorio_site/js/old/$DateStr/locations-data-update.js" -Recurse -force
